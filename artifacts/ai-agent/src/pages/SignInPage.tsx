...
export function SignInPage() {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col items-center gap-8 p-8 rounded-2xl w-full max-w-sm"
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          />
          <span
            className="synapse-logo-text text-lg font-bold tracking-widest uppercase"
        ...
        <div className="text-center">
          ...
          <p className="text-sm mt-1" style={{ color: "hsl(210 15% 60%)" }}>
